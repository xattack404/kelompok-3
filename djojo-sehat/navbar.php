...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="search"></div>
      ...
      if(!empty($_SESSION['username']) && empty($_SESSION['usertype']))
      {
        ...
        {
          echo "<button type='button' class='btn btn-primary' style ='margin-top:7px; margin-right:3px;' data-toggle='modal' data-target='#registerform'><span class='glyphicon glyphicon-user' aria-hidden='true'></span>
          Register
        </button>";
