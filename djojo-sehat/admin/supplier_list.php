...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Daftar Suppleir | <?php include "title.php" ?></title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Daftar Supplier <small><a href="user_add.php">Tambah Supplier Baru</a></small></h1>
          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li>User</li>
            <li class="active"><a href="user_list.php">Daftar Supplier</a></li>
          </ol>
        </section>
