...
<head>
  <meta charset="UTF-8">
  <title>Daftar Satuan | <?php include "title.php" ?></title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>Daftar Satuan Barang <small><a href="satuan_add.php">Tambah Satuan Barang</a></small></h1>
        <ol class="breadcrumb">
          <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
          <li>Satuan</li>
          <li class="active"><a href="satuan_list.php">Daftar Satuan Barang</a></li>
        </ol>
      </section>

      <section class="content">
        <?php include "satuan_list_data.php" ?>
      </section>
    </div>
