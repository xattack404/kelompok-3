    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <div class="form-group"><label>Jenis Kelamin</label><br><?php 
            if ($data['jenis_kelamin'] == "Perempuan"){?>
              <input type="radio" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value ="Laki-laki" > Laki-laki
              <input type="radio" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value ="Perempuan" checked="checked">Perempuan
            <?php}else{?>
              <input type="radio" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value ="Laki-laki" checked="checked" > Laki-laki
        ...
        <div class="box-body">
           <div class="row"> <!-- buka row-->
            ...
            <div class="col-xs-6"><label>Provinsi</label>
              ...
              <option value="<?= $data['provinsi'] ?>">--Pilih Provinsi--</option>
                <?php
            ...
            <div class="col-xs-6"><label>Kabupaten</label>
              <select name="kabupaten" id="kot" class="form-control" required style="cursor: pointer;">
                <option value="<?= $data['kabupaten'] ?>">--Pilih Kabupaten/ Kota--</option>
              </select>
            </div>
          </div><!-- tutup row--><br>
          <div class="row">
