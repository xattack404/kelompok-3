...
<head>
  <meta charset="UTF-8">
  <title>Daftar Konsultasi | <?php include "title.php" ?></title>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Konsultasi</li>
          <li class="active"><a href="konsultasi_list.php">Daftar Kategori</a></li>
        </ol>
      </section>

      <section class="content">
        <?php include "konsultasi_list_data.php" ?>
      </section>
    </div>
